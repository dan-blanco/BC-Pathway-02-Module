...
candidate_database = {
    "Lane": ["Lane", "0xaC8eB8B2ed5C4a0fC41a84Ee4950F417f67029F0", "4.3", .0000020, "Images/lane.jpeg"],
    "Ash": ["Ash", "0x2422858F9C4480c2724A309D58Ffd7Ac8bF65396", "5.0", 0.0033, "Images/ash.jpeg"],
    "Jo": ["Jo", "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45", "4.7", .0019, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45", "4.1", .0000016, "Images/kendall.jpeg"]
}
...
st.sidebar.write(f'### Gas Estimate')
st.sidebar.write(gasEstimate)



if st.sidebar.button("Send Transaction") and wage >0:
    ...
    st.markdown(transaction_hash.hex())
